...
object RhinoClassShutter : ClassShutter {
    ...
    private val protectedClassNamesMatcher by lazy {
        listOf(
            ...
            "org.peyilo.booksource.data.AppDatabase",
            "org.peyilo.booksource.data.AppDatabase_Impl",
            "org.peyilo.booksource.data.AppDatabaseKt",
            "org.peyilo.booksource.utils.ContextExtensionsKt",
            ...
            "java.lang.reflect",
            "java.lang.invoke",
            "org.peyilo.booksource.data.dao",
            "com.script",
            "org.mozilla",
            "sun",
            "libcore",
    ...
    private val protectedClasses by lazy {
        arrayOf(
            ...
            // Android 8.0(API 26) 及以上，才有 java.nio.file.FileSystem、Path
            // 但是Java7就已经引入了FileSystem、Path，所以无需添加额外的判断
            FileSystem::class.java,
            Path::class.java
            // 由于不在Android环境使用，android.content.Context不需要加入
