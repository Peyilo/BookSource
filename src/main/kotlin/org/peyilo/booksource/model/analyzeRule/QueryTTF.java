...
//        Log.i("QueryTTF", "字体处理完成");
    ...
    public boolean isBlankUnicode(int unicode) {
        switch (unicode) {
            ...
            case 0x0020: // 空格 (Space)
            case 0x00A0: // 不中断空格 (No-Break Space)
            case 0x2002: // En空格 (En Space)
            case 0x2003: // Em空格 (Em Space)
            case 0x2007: // 刚性空格 (Figure Space)
            case 0x200A: // 发音修饰字母的连字符 (Hair Space)
            case 0x200B: // 零宽空格 (Zero Width Space)
            case 0x200C: // 零宽不连字 (Zero Width Non-Joiner)
            case 0x200D: // 零宽连字 (Zero Width Joiner)
            case 0x202F: // 狭窄不中断空格 (Narrow No-Break Space)
            case 0x205F: // 中等数学空格 (Medium Mathematical Space)
                return true;
            default:
                return false;
        }
