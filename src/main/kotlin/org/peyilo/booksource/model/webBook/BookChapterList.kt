...
import org.peyilo.booksource.data.entities.rule.TocRule
import org.peyilo.booksource.exception.NoStackTraceException
import org.peyilo.booksource.exception.TocEmptyException
...
import org.peyilo.booksource.model.analyzeRule.AnalyzeRule.Companion.setChapter
...
import org.peyilo.booksource.utils.isTrue
...
object BookChapterList {
    ...
    suspend fun analyzeChapterList(
        ...
        body ?: throw NoStackTraceException(
            "Failed to access website:$baseUrl"
        )
        ...
        if (chapterList.isEmpty()) {
            throw TocEmptyException("Chapters is empty")
        }
        if (!reverse) {
            chapterList.reverse()
        }
    ...
    private fun getWordCount(list: ArrayList<BookChapter>, book: Book) = Unit
