package org.peyilo.booksource.model.webBook
...
import org.peyilo.booksource.data.entities.SearchBook
import org.peyilo.booksource.data.entities.rule.BookListRule
...
import org.peyilo.booksource.help.source.exploreKindsJson
import org.peyilo.booksource.help.source.getBookType
...
import org.peyilo.booksource.model.analyzeRule.AnalyzeRule.Companion.setRuleData
...
import org.peyilo.booksource.utils.StringUtils.wordCountFormat
...
object BookList {
    ...
    /**
     * 在这里解析html页面，返回搜索得到的书籍
     * @param body 搜索请求返回的html页面
     */
