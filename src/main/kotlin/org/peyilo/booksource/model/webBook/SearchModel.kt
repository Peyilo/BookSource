...
import org.peyilo.booksource.ui.book.search.SearchScope
import org.peyilo.booksource.utils.getPrefBoolean
import org.peyilo.booksource.utils.mapParallelSafe
...
class SearchModel(private val scope: CoroutineScope, private val callBack: CallBack) {
    ...
    private fun startSearch() {
        val precision = appCtx.getPrefBoolean(PreferKey.precisionSearch)        // 是否开启精准搜索
        var hasMore = false
